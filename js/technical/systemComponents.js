...
var systemComponents = {
	...
	'overlay-head': {
		...
		<br>
		<span v-if="canGenPoints()"  class="overlayThing">({{tmp.other.oompsMag >= 1 ? format(tmp.other.oomps) + " OOM" + (tmp.other.oompsMag > 1 ? "^" + tmp.other.oompsMag : "") + "s" : format(getPointGen())}}/秒)</span>
