...
function openCreditsModal() {
	modal.show(
		...
		`
            ...
            <h5 style="padding-top:5px">original idea [?] by</h5><h3>papyrus#6977</h3>
            <h5 style="padding-top:5px">The Modding Tree <a href="https://github.com/Acamaeda/The-Modding-Tree/blob/master/changelog.md" target="_blank" class="link" style="font-size:12px;display:inline" >${TMT_VERSION.tmtNum}</a> by</h5><h3>Harley "Acamaeda" White</h3>
			<br><br>
			<h2>Act 0</h2>
            ...
            <br><br>
			<h5>Save Bank Contributor</h5>
            <h3>Lady Kayumi#8888</h3>
            <br>
		`,
		"Ok"
	)
