if (act.startsWith("0")) addLayer("skaia", {
    ...
    tooltip() {
        return "Skaia 等级 " + formatWhole(player.skaia.level) + "<br><span style='font-size:12px'>" + formatWhole(player.skaia.points.floor()) + " Echepoints<br>" + (!tmp.skaia.effect.climbReq || tmp.skaia.effect.climbReq.gte(1e9) ? "" : "(+" + format((player.skaia.points % 1) * 100) + "%)") + "</span>"
    },
