addLayer("aspBlood", {
    ...
    buyables: {
        ...
        19: {
            ...
            effect(x) { return (x || getBuyableAmount(this.layer, this.id)).max(1).log(50).add(1).log(50).add(1) },
            canAfford() { return player[this.layer].power.gte(this.cost()) && player[this.layer].buyables[this.id].lte(0) },
            title() {
        ...
        21: {
            ...
            effect(x) { return (x || getBuyableAmount(this.layer, this.id)).max(1).log(2).add(1).log(1.2).add(1) },
            canAfford() { return player[this.layer].power.gte(this.cost()) && player[this.layer].buyables[this.id].lte(0) },
            title() {
        ...
        24: {
            ...
            effect(x) { return (x || getBuyableAmount(this.layer, this.id)).max(1).log(2).add(1).log(2).add(1) },
            canAfford() { return player[this.layer].power.gte(this.cost()) && player[this.layer].buyables[this.id].lte(0) },
            title() {
